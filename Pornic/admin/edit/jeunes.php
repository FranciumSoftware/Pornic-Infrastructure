...
require_once 'fields/jeunes.php'; // Assurez-vous que ce fichier contient le tableau $classes
...
<body>
    <h2>Éditer les contenus de la page jeunes</h2>
     <div id="navbar">
        <a href="./">Accueil</a>
    ...
    <form method="post">
        <button type="submit" name="logout" value="1"><i class="fa-solid fa-xmark"></i> Déconnexion</button>
    </form>
</body>
